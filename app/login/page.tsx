...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="relative lg:w-3/5 flex flex-col items-center justify-center px-10 py-16 bg-gradient-to-br from-green-900/60 via-[#060f08] to-[#060f08] overflow-hidden">
        ...
        <div className="relative z-10 max-w-md w-full">
          ...
          {/* Tagline */}
          <p className="text-green-100/80 text-lg font-medium leading-relaxed mb-10">
            La plataforma de gestión para el grupo de Puchito FC.
      ...
      <div className="lg:w-2/5 flex items-center justify-center px-8 py-16 border-l border-green-900/40">
